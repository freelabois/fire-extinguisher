...
return [
    ...
    */
    ...
    'cpf_cnpj'             => 'O campo :attribute deve conter um CPF ou CNPJ válido',
    "device_in_use" => "Dispositivo :device está em uso.",
    ...
    */
    ...
    'custom' => [
        ...
        'phone' => [
            'unique' => 'O numero de telefone informado já está em uso'
        ],
       'expiration_date' => [
          'after' => 'O campo :attribute deve conter uma data posterior a hoje.',
       ],
        'confirmation_type' => [
            'required' => 'Houve um problema ao processar sua solicitação, tente novamente. Caso o problema persista contate o suporte.'
        ]
    ],
